"""
simple pascal interpreter, based on 17.py
- excute procedure call
...
class ActivationRecord:
    def __init__(self, name, type: ARType, nesting_level):
        self.name = name
        self.type = type
...
class Interpreter(NodeVistor):
    ...
    def visit_Program(self, node: Program):
        ...
        ar = ActivationRecord(prog_name, ARType.PROGRAM, self.call_stack.current_level+1)
    ...
    def visit_ProcedureCall(self, node: ProcedureCall):
        proc_name = node.name
        proc_ar = ActivationRecord(proc_name, ARType.PROCEDURE, self.call_stack.current_level+1)
